      ...
      <div class="navbar navbar-dark shadow-sm" style="background-color: black;">
        <div class="container d-flex justify-content-between">
          <a href="#" class="navbar-brand d-flex align-items-center">
            <img src="<?php echo e(asset('storage/image/ZEALTEAM_logo.jpg')); ?>" alt="Image" class="image-size" style ="width:250px; height:50px;">          </a>
      ...
      <div class="col-md-4 mb-4"> <!-- Added 'col-md-4' class for column sizing and 'mb-4' for margin-bottom -->
        <div class="card box-shadow">
          <div class="profilepicture">
            <img class="card-img-top mx-auto" src="<?php echo e(asset('storage/image/'.$information->profilepic)); ?>" alt="Card image cap" style="width: 100%;">
          </div>
          <div class="card-body">
            <div class="post-grid">
              <h6><?php echo e($information->name); ?></h6>
              <small class="time-stamp" style="padding-left: 2px;"><?php echo e($information->created_at->format('Y-m-d H:i:s')); ?></small>
            </div>
            <!-- <p class="card-text"><?php echo e($information->email); ?></p> -->
            <a href="mailto:<?php echo e($information->email); ?>"><?php echo e($information->email); ?></a>
            <p class="introduction"><?php echo e($information->introduction); ?></p>
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                ...
                <button type="button" class="btn btn-sm btn-outline-secondary" onclick="shareToFacebook('<?php echo e($information->name); ?>', '<?php echo e(asset('storage/image/'.$information->profilepic)); ?>', '<?php echo e(route('information.show', $information->id)); ?>')">Share on Facebook</button>
              </div>
...
<?php /**PATH C:\XXAMP\htdocs\facebookpost\resources\views/about-us.blade.php ENDPATH**/ ?>